...
|------|----------|----------|------|
| 3.5年ECM密度 | 0.291 | — | — |
| ECM增长倍数 | 5.8x | 2.5x | Suki & Bates 2024 |
| 稳态ECM | 0.841 | — | — |
...
| 指标 | 模型值 | 临床参考 |
|------|--------|----------|
| 正常肺顺应性 | 0.156 L/cmH₂O | 0.2 L/cmH₂O |
| IPF肺顺应性 (E=0.8) | 0.032 L/cmH₂O | 0.05-0.10 L/cmH₂O |
...
| 丹参 | 0.191 | 0.303 | 34.2% |
| 甘草 | 0.231 | 0.362 | 20.6% |
| 尼达尼布 | 0.165 | 0.253 | 43.3% |
| 吡非尼酮 | 0.181 | 0.282 | 37.7% |
| combo_huangqi_danshen | 0.121 | 0.176 | 58.2% |
